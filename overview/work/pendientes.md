...
| p21 | 2026-09-21 | Internacionalización i18n | **Normalización UI Base Inglés & Tier 1 (ES, IT, FR):** Refactorizar labels base del código fuente a inglés canónico (`ui/panels.py`, `ui/menus.py`, `core/`) y completar catálogos de traducción en `ui/i18n.py` para Español (`es_ES`), Italiano (`it_IT`) y Francés (`fr_FR`). | `pendiente` |
