...
|---|---|---|---|---|
| [w56] | mejora | en progreso | Agregar campo `website` y metadatos oficiales a `blender_manifest.toml` y `pack_common.py`. | `blender_manifest.toml`, `tools/pack_zip/pack_common.py` |
